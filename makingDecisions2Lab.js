...
if (score >= 90) {
  ...
  console.log("Okay come on man, that's not even a score. Get your head in the game.")
}
...
// let someNum = myFavoriteNumbers.slice(0,6)
// let someNum = myFavoriteNumbers.slice(1,4)
// someNum = someNum + "," + myFavoriteNumbers.slice(5,6)
console.log(someNum)
...
if (myFavoriteNumbers.length >= 7) {
  ...
  console.log("I don't think this is an array bro.")
}
